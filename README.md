...
- Las funciones implementadas en el sistema son:
    1. Registrar talleres, para agregarlos al sistema.
    2. Listar talleres, para mostrar la data de los talleres registrados en el sistema.
    3. Buscar talleres, para encontrar un taller regsitrado X utilizando el código con el cual se cargó en el sistema.
    4. Actualizar talleres, para actualizar los datos de los talleres utilizando el código asociado en el sistema.
    5. Eliminar talleres, para borrar del sistema el taller correspondiente el código utilizado para buscarlo.